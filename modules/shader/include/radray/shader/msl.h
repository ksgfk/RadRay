...
public:
    ...
    uint32_t StructTypeIndex{std::numeric_limits<uint32_t>::max()};
    uint32_t ArrayTypeIndex{std::numeric_limits<uint32_t>::max()};
};
...
public:
    ...
    uint64_t Stride{0};
    uint32_t ElementStructTypeIndex{std::numeric_limits<uint32_t>::max()};
    uint32_t ElementArrayTypeIndex{std::numeric_limits<uint32_t>::max()};
};
...
public:
    ...
    uint32_t BufferStructTypeIndex{std::numeric_limits<uint32_t>::max()};
