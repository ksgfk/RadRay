...
if (WIN32)
    ...
    if (RADRAY_DXC_COPY_RUNTIME)
        file(GLOB _DXC_EXTRA_DLLS "${_DXC_BIN_DIR}/dxil.dll")
        set(RADRAY_DXC_RUNTIME_DLLS "${_DXC_DLL};${_DXC_EXTRA_DLLS}" CACHE INTERNAL "DXC runtime binaries")
    endif()
elseif (APPLE)
    ...
    if (RADRAY_DXC_COPY_RUNTIME)
        if (EXISTS "${_DXC_ROOT}/lib/libdxil.dylib")
            set(RADRAY_DXC_RUNTIME_DLLS "${_DXC_ROOT}/lib/libdxil.dylib" CACHE INTERNAL "DXC runtime binaries (macOS)")
        endif()
    endif()
else()
    # Linux
    ...
    if (RADRAY_DXC_COPY_RUNTIME)
        if (EXISTS "${_DXC_ROOT}/lib/libdxil.so")
            set(RADRAY_DXC_RUNTIME_DLLS "${_DXC_ROOT}/lib/libdxil.so" CACHE INTERNAL "DXC runtime binaries (Linux)")
        endif()
    endif()
endif()
